...
**Current lead**: none  
**Status**: NPG-GCL, fixed-sign SC-BGRL, and GDC-GCL+ are downgraded; restart wide idea discovery.

| Rank | Candidate | Mechanism | Fair-test status | Compute | Risk | Status |
|---:|---|---|---|---:|---|---|
| 1 | GDC-GCL+ | gradient-residual training dynamics positives/weights | split-0 gate failed | done | MEDIUM | FAILED_SPLIT0_GATE |
| 2 | NPG-GCL | weight positive alignment by nontrivial gain over message-passing prealignment | weak split-0 signal; no 3-split | done | MEDIUM | WEAK_SIGNAL_DEPRIORITIZED |
| 3 | SC-BGRL | signed same/different-compatible aggregation views | fixed-sign fair pilot failed | done | MEDIUM-HIGH | FAILED_FIXED_SIGN_PILOT |
...
comparison was also too weak. Next action: regenerate candidates from a wider
mechanism family.
