...
**Status**: NPG-GCL, fixed-sign SC-BGRL, and GDC-GCL+ are downgraded; LIFT-PROP-GCL is active with novelty risk.

| Rank | Candidate | Mechanism | Fair-test status | Compute | Risk | Status |
|---:|---|---|---|---:|---|---|
| 1 | LIFT-PROP-GCL | label-free edge-lift gate selects raw vs `P^2X` propagation | M0 proxy positive; novelty pending | done | MEDIUM | ACTIVE_WITH_NOVELTY_RISK |
