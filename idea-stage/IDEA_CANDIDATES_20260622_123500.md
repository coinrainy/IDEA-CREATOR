...
**Current lead**: LIFT-PROP-GCL  
**Status**: NPG-GCL, fixed-sign SC-BGRL, and GDC-GCL+ are downgraded; LIFT-PROP-GCL proceeds with caution after novelty check.

| Rank | Candidate | Mechanism | Fair-test status | Compute | Risk | Status |
|---:|---|---|---|---:|---|---|
| 1 | LIFT-PROP-GCL | label-free edge-lift gate selects raw vs `P^2X` propagation | M0 proxy positive; novelty 5.5/10 | done | MEDIUM | ACTIVE_PROCEED_WITH_CAUTION |
...
Fast-grid Actor/Squirrel 10-split shows the abstention gate transfers, but
Squirrel prefers K1 over fixed K2. Next action: refine a label-free K1/K2
selector and compare to PROPGCL-style propagation.
