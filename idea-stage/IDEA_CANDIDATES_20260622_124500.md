...
|---:|---|---|---|---:|---|---|
| 1 | LIFT-PROP-GCL | label-free edge-lift abstention plus K1/K2 selector | selector v1 hits oracle on 7/8 observed settings; novelty 5.5/10 | done | MEDIUM | METHOD_V1_PROCEED_WITH_CAUTION |
...
PROPGCL-style propagation and add theory/diagnostics for edge-lift.
