...
extensions, LIFT-HC-GCL, and LIFT-Stack checkpoint residuals are downgraded;
LIFT-Stack is the strongest low-novelty control.
...
| 4 | LIFT-PROP-GCL | label-free edge-lift abstention plus K1/K2 selector | selector v1 hits oracle on 7/8 observed settings, but R077/R078 failed to make it a full GCL-training method | done | MEDIUM | SELECTOR_BASELINE_NOT_MAIN_METHOD |
| 5 | GDC-GCL+ | gradient-residual training dynamics positives/weights | split-0 gate failed | done | MEDIUM | FAILED_SPLIT0_GATE |
