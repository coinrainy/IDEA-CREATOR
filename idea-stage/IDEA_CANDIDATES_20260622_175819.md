...
**Current lead**: CCR-SAFE diagnostic only; no active main method  
...
LIFT interaction features, EPI-BGRL, PAB-BGRL, and CCR-GCL are downgraded;
...
| 6 | CCR-SAFE | fixed label-free residual-safety policy over CCR residuals | accepts only Cora and protects CiteSeer/Chameleon/WebKB on split-0 diagnostic | done | HIGH overfit risk until fresh splits | PROMISING_DIAGNOSTIC_NOT_METHOD_READY |
| 7 | Spillover-Blocked BGRL | block harmful neighbor gradient spillover without deleting edges | needs gradient-path prototype | 4-6 GPUh | HIGH | ACTIVE_BACKUP |
| 8 | Positive-Abstention PU-GCL | positive/unlabeled/abstain pair calibration | ready after pair gate utilities | 3 GPUh | MEDIUM | ACTIVE_BACKUP |
| 9 | Depth-Disagreement Contrast | 1/2/4-layer views with oversmoothing-aware disagreement | ready | 3 GPUh | MEDIUM | ACTIVE_BACKUP |
