...
**Current candidate**: no active pilot after NPG-GCL, fixed-sign SC-BGRL, and GDC-GCL+ all failed local gates  
**Decision**: restart wide idea discovery with a different mechanism family.
