...
**Current candidate**: LIFT-PROP-GCL is active with novelty risk after a strong zero-training reliability-gate proxy  
**Decision**: run direct novelty check and broader dataset validation before any paper-level claim.
