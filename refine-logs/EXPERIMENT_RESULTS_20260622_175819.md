...
**Decision**: LIFT-Portfolio is the strongest required baseline. CCR-SAFE has
a promising residual-safety diagnostic, but it is not method-ready until the
same fixed thresholds survive fresh splits.
